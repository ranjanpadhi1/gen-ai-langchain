...
CREATE TABLE department(dept_no int(2) not null primary key, dname varchar(50) not null, location varchar(50) not null);
CREATE TABLE employee(empno int(4) not null primary key, ename varchar(50) not null, job varchar(50) not null, mgr int(4), hiredate date, salary decimal(10,2), commission decimal(10,2), dept_no int(2) not null);
